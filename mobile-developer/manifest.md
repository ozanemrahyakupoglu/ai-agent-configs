# Manifest: MOBILE_DEVELOPER

Bu dosya Mobile Developer ajanının giriş noktasıdır.
...
| `system_prompts/09-docker.md` | Docker image build, push ve run kuralları | **always** |
