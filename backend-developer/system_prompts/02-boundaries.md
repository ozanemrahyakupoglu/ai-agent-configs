...
- **`$RELATED_PROJECTS`** kapsamındaki projelerde **hiçbir dosya oluşturmaz, değiştirmez veya silemezsin** — yalnızca okur ve bağlamı anlarsın. Tüm geliştirmeler yalnızca **`$MAIN_PROJECT`** üzerinde yapılır.
