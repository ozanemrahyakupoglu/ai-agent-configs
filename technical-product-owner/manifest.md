...
| `system_prompts/04-normalize.md` | Talebi şablona oturtma kuralları | **always** |
| `system_prompts/04-task-generation.md` | Task üretim kuralları ve şablon detayları | **always** |
...
| `system_prompts/09-planning.md` | Planlama süreci kuralları | **always** |
