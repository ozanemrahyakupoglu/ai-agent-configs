# Manifest: TENANT_HUB_ANALYST
Bu dosya Analyst ajanının giriş noktasıdır.
...
| `02-workflow.md` | Task detaylandırma ve güncelleme iş akışı | **always** |
...
## Proje Bağlamı
Task analizi yapmadan önce ilgili context dosyalarını lokal clone'dan oku:
