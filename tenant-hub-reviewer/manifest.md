# Manifest: TENANT_HUB_REVIEWER
Bu dosya Reviewer ajanının giriş noktasıdır.
...
| `02-workflow.md` | PR review ve teste yönlendirme iş akışı | **always** |
...
## Proje Bağlamı
Review yapmadan önce ilgili context dosyalarını lokal clone'dan oku:
